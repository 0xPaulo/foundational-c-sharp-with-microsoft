...
//                         if (entry != null)
//                         {
//                             setAge = int.TryParse(entry, out age);
//                         }

//                     } while (setAge != true);
//                     ourAnimals[i, 2] = $"Age: {age}";

//                     bool setPhysical = false;
//                     do
//                     {
//                         System.Console.WriteLine("Enter a physical description for ID #: c4 (size, color, breed, gender, weight, housebroken)");
//                         string entry = Console.ReadLine();
...
//                     do
//                     {
//                         System.Console.WriteLine($"Enter a nickname for ID #: {ourAnimals[i, 0]}");
//                         string entry = Console.ReadLine();
//                         if (!String.IsNullOrEmpty(entry))
//                         {
...
//                     } while (setNickName != true);

//                     bool setPersonality = false;
//                     do
//                     {
//                         System.Console.WriteLine($"Enter a personality description for ID #: {ourAnimals[i, 0]} (likes or dislikes, tricks, energy level)");
//                         string entry = Console.ReadLine();
//                         if (!String.IsNullOrEmpty(entry))
//                         {
//                             ourAnimals[i, 4] = $"Nickname: {entry}";
//                             setPersonality = true;
//                         }
//                     }
//                     while (setPersonality != true);
//                 }
